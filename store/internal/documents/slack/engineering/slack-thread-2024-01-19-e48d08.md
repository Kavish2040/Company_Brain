...
relations:
  ...
  - predicate: mentions
    ...
    evidence:
      - node: self
        span: [91, 201]
        quote: '**Dev Oyelaran** (12:46): Handing the Customer escalation ticket over to Support, they own the customer comms.'
  - predicate: mentions
    ...
    evidence:
      - node: self
        span: [0, 89]
        quote: '**Priya Raman** (12:39): The NetSuite alert fired again overnight — third time this week.'
  - predicate: mentions
